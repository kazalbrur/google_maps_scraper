...
def main():
    ...
    with sync_playwright() as p:
        ...
        # Go to Google Maps with English language selection
        ...
        for search_for_index, search_for in enumerate(search_list):
            ...
            for listing in listings:
                try:
                    ...
                    name_attribute_value = listing.get_attribute(name_attibute)
                    if name_attribute_value and len(name_attribute_value) >= 1:
                    ...
                    if page.locator(review_count_xpath).count() > 0:
                        ...
                        business.reviews_count = None  # Use None for better clarity
                    ...
                    if page.locator(reviews_average_xpath).count() > 0:
                        ...
                        business.reviews_average = None  # Use None for better clarity
